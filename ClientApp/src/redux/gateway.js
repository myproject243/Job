...
export function getCall(url) {
 ...
 export function postCall(url, data){
  return  axios.post(rootUrl + url, data, 
    { headers: {
  ...
  export async function postPutCall(url,data, type = 'post'){
      try {
        var promise = new Promise((resolve, reject) => {
            if(type == 'post')
           resolve( axios.post(rootUrl + url, data,
                { headers: {
                        'Authorization' : localStorage.getItem('token').toString(),
                    }
                })
            ...
            resolve( axios.put(rootUrl + url, data,
                { headers: {
                        'Authorization' : localStorage.getItem('token').toString(),
                    }
                })
  ...
  export function genericCall(url, data, type = 'get'){
    ...
    var promise = new Promise((resolve, reject) => {
        if(type == 'get'){
       resolve( axios.get(rootUrl + url, 
            { headers:authHeader })
         )
        }
       else if(type == 'delete'){
        resolve( axios.delete(rootUrl + url, 
            { headers:authHeader })
            )
       }
       if(type == 'post')
